...
\begin{resume}
  ...
  % \begin{textblock}{1}(12, 15.6)
  %   {
  %     \begingroup
  %     \hypersetup{urlcolor=gray!30, linkcolor=gray!30, citecolor=gray!30}
  %     \href{https://github.com/alchemmist/CV}{Open~Source\,\faGithub}
  %     \endgroup
  %   }
  % \end{textblock}
...
\begin{description}
  \item[Формальная верификация:] \inlinecode{Coq}
