...
% TODO: махнуть местами месатми достижения и сертификаты
% TODO:
...
\begin{resume}
  ...
  Математика и компьютерные науки, 2028 \textit{(1 курс)}. Направление «Разработка». Траектория «Computer Science Research».
  % TODO: уточнить трек
