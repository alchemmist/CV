...
{\vspace*{-13mm}\sc \large Гришин Антон --- backend-разработчик, грейд 15} \\
\begin{resume}
  ...
  \begin{itemize}[leftmargin=4mm, itemsep=0pt, topsep=1pt, parsep=0pt, label=\raisebox{0.2ex}{\scalebox{0.6}{\textbullet}}]
    ...
    \item Внедрил штатный \texttt{rollback-flow} в \texttt{CI} и автооткат
  ...
  \section{\mysidestyle Опыт на Go}
  Спроектировал и реализовал на \texttt{Go} архитектуру
  \href{https://github.com/ballkit/ballkit-platform}{Telegram-бота Ballkit}
  для программы лояльности малого бизнеса: \texttt{gRPC}, \texttt{gofsm}.
  Разработал \href{https://github.com/alchemmist/lazy-tmux}{\texttt{lazy-tmux}}:
  сохранение и ленивое восстановление сессий \texttt{tmux},
  \texttt{TUI} с поиском и демон автосохранения.
  Создал \href{https://github.com/alchemmist/devsyringe}{\texttt{Devsyringe}} ---
  \texttt{CLI} для подстановки значений по \texttt{YAML}-спецификациям.
  Стек инструментов: \texttt{Bubble Tea}, \texttt{Lip Gloss}, \texttt{Cobra}.
