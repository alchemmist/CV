...
\begin{resume}
  ...
  \begin{description}[leftmargin=0pt, itemindent=*, itemsep=8pt]
    ...
    \item[lazy-tmux:]
      \href{https://github.com/alchemmist/lazy-tmux}{Инструмент для
      управления tmux-сессиями} с ленивой загрузкой конфигураций и плагинов.
      Реализовал динамическую инициализацию окон и панелей, настройку
      горячих клавиш и удобный TUI для навигации между сессиями.
      Позволяет быстро разворачивать и сохранять рабочие окружения разработчика.
      Стек: \inlinecode{Go}, \inlinecode{tcell},
      \inlinecode{bubbletea}, \inlinecode{tmux}.
