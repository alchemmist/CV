...
\definecolor{sidebarcolor}{RGB}{47,79,79} % forest - nice
...
% TODO: во ВСЕХ readme должны быть скрины
% TODO: попробывать опыт вынести в начало
% TODO: в шапке сузить: backend (python, go)
% TODO: сделать, 3 резюме: под python, под go, и общее -- то которе сейчас
% TODO: выбрать несколько жирных проектов и их расписать подробнее
% TODO: убрать даты там где не надо
...
\begin{resume}
  ...
  это время участвовал в разработке \githubrepos\ репозиториев, отправил \githubcommits\  
  ...
  \begin{description}
      ...
      \item[Ballkit]\small\href{https://github.com/ballkit}{Программа лояльности для малого бизнеса} \hfill
      \textsl{Июль 2024 — Август 2024\vspace{1mm}}\\
      С нуля спроектировал и \href{https://github.com/ballkit/ballkit-platform}{реализовал} на \inlinecode{Go} архитектуру для бота в Telegram по модели SMB (Single Message Bot) для коробочной системы лояльности
  ...
  \begin{description}
    ...
    \item[Corpse]\small{\href{https://github.com/corpse-inc/corpse}{Игровой
      ...
      \item[Devsyringe]\small{\href{https://github.com/alchemmist/devsyringe}{CLI инструмент}
          \hfill
        \textsl{Август 2025\vspace{1mm}}}\\
        Разработал \href{https://devsyringe.alchemmist.xyz/}{\texttt{cli}-инструмент} для инъектирования динамических значений в файлы на основе декларативных правил из \texttt{YAML} конфигурации. Реализовал полноценный \href{https://github.com/alchemmist/devsyringe/blob/main/internal/cli/commands.go}{инструментай команд} и \href{https://github.com/alchemmist/devsyringe/blob/main/internal/cli/tui/tui.go}{\texttt{TUI}} интерфейс для управления системными процессами. Настроил пайплайн \href{https://github.com/alchemmist/devsyringe/blob/main/.github/workflows/build.yaml}{сборки} и \href{https://github.com/alchemmist/devsyringe/blob/main/.github/workflows/release.yaml}{выпуска} новых релизов. Сделал удобную установку из репзоиториев \texttt{Go}, \texttt{AUR}, \texttt{brew} для MacOS и Linux.
    ...
    \begin{description}
      \item[Telegram боты]\small{
        ...
        \item{Разработал
            ...
            Стек: \inlinecode{Python}, \inlinecode{sqlite},
      ...
      \item[Другие проекты]\small{
        ...
        \item{
            ...
            Стек: \inlinecode{Python}, \inlinecode{selenium},
            \inlinecode{psycopg},
        ...
        \item{
            % \begingroup
            % \hypersetup{urlcolor=linkcolor!30}
