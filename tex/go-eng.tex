...
\begin{resume}
  ...
  \begin{description}
    ...
    \item[Patch Loyalty] Loyalty program for small businesses \hfill
      ...
      Developed a Telegram bot based on the SMB (Single Message Bot) model in \inlinecode{Go} for a boxed loyalty system:
  ...
  {\textbf{Formal Verification:} I'm taking the course
    ...
    \href{https://github.com/alchemmist/coq-learning}{proved} 250 theorems in \inlinecode{Coq}.} \\
